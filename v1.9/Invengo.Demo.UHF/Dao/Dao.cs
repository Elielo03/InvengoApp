...
namespace Invengo.Sample.Dao
{
    ...
    class Dao
    {
        ...
        public Boolean addMarcaje(int idPersona,int idEmpresa, string Empresa, string numNomina, string credencial, string esFamiliar)
        {
            ...
            string sql = "INSERT INTO marcajeAutobus(marcaje,idPersona,idEmpresa,numNomina,credencial,esFamiliar,Empresa) values(DateTime('now','localtime')," + idPersona + "," + idEmpresa + ",'" + numNomina + "','" + credencial + "','" + esFamiliar + "','" + Empresa + "')";
